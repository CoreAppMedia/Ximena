...
public struct EmojiProvider {
  ...
  static func all() -> [EmojiDetails] {
    return [// estruct donde estan las recetas USA \n para hacer el salto de linea
      EmojiDetails(
  //      emoji: "",
        name: "Brusquetas con Queso Feta, Aguacate y Tomate",
        description: "Ingredientes: 2 rebanada Pan integral, 70 g Queso Feta,1/2 ud Aguacate, 6 ud Tomate Cherry,Rúcula,Escamas de sal Marina,1 cda Aceite de Oliva Virgen\n -paso 1:Cortamos el pan en trozos de más o menos ½ pulgada de grosor.Cubrimos con aceite de oliva virgen\n -paso 2: Cortamos el queso Feta y desmigamos repartiendo sobre las tostadas. Cortamos aguacate en rodajas finas. Colocamos sobre las bruschettas de forma armónica.\n -paso 3: A continuación ponemos los tomatitos cherry cortados por la mitad.Espolvoreamos escamas de sal Marina\n -paso 4: Para terminar añadimos unas gotas de aceite de oliva virgen y decoramos con rúcula.",
        image: "tostadas"),
